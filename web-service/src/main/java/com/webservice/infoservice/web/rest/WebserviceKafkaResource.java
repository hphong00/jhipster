...
@RestController
@RequestMapping("/api/webservice-kafka")
public class WebserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebserviceKafkaResource.class);
    ...
    public WebserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }

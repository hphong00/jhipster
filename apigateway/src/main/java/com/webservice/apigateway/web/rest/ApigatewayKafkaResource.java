package com.webservice.apigateway.web.rest;

import com.webservice.apigateway.config.KafkaSseConsumer;
import com.webservice.apigateway.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/apigateway-kafka")
public class ApigatewayKafkaResource {
    ...
    public ApigatewayKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
